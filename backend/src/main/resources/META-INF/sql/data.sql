...
INSERT INTO POLLS (user_id, time_limit, is_active) VALUES ((SELECT id from FEEDAPPUSERS WHERE email='janne@hvl.no'), 100, 1)
INSERT INTO POLLS (user_id, time_limit, is_active) VALUES ((SELECT id from FEEDAPPUSERS WHERE email='sigve@hvl.no'), 50, 1)
INSERT INTO POLLS (user_id, time_limit, is_active) VALUES ((SELECT id from FEEDAPPUSERS WHERE email='sigve@hvl.no'), 100, 0)
